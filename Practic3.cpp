...
На некоторых компиляторах может вызывать ошибку. Не уверена, с чем это связано.
Попробуйте просто запустить программу ещё раз (видимо,это засисит от версии Studio и установленных модификаций).
Не бейте меня тапками, в программировании я новичок.
